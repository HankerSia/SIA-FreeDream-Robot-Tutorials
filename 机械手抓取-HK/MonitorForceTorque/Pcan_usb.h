...
//  ~~~~~~~~~~~~
//
//	- CAN_Init( WORD    wBTR0BTR1, int Type)		
//	- CAN_Close(void)  
//	- CAN_Status(void) 
//	- CAN_Write(TCANMsg *PCANMsg) 
//	- CAN_Read(TCANMsg *PCANMsg)  
//	- CAN_VersionInfo(LPSTR lpszTextBuff) 
//	- CAN_ResetClient(void) 
//	- CAN_MsgFilter(DWORD FromID,DWORD ToID, int Type) 
//	- CAN_ResetFilter(void) 
//	- SetUSBDeviceNr(long uDevNo) 
//	- GetUSBDeviceNr(long *uDevNo) 
//
//  ------------------------------------------------------------------
...
#define CAN_ERR_HWINUSE        0x0400  // The Hardware is alraedy occuped by a Net
